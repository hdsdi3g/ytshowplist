...
public class Quickstart {
	...
	/**
	 * Global instance of the scopes required by this quickstart. If modifying these scopes, delete your previously saved credentials ./credentials/drive-java-quickstart
	 */
