 ...
 * 
 * IMPORTED FROM https://github.com/youtube/api-samples 
 */
...
public class Auth {
	 ...
	 */
	private static final String CREDENTIALS_DIRECTORY = "credentials";// XXX
	...
	public static Credential authorize(List<String> scopes, String credentialDatastore) throws IOException {
		...
		if (clientSecrets.getDetails().getClientId().startsWith("Enter") || clientSecrets.getDetails().getClientSecret().startsWith("Enter ")) {
			System.out.println("Enter Client ID and Secret from https://console.developers.google.com/project/_/apiui/credential into ./clientid.json");
			System.exit(1);
		}
